...
Author: Akshay
Copyright: All parts of this document and the BrowserCraft project belongs to Akshay.
...
new BCEngine.Block("Water",5,0.25),
new BCEngine.Block("Brick",6,2),
new BCEngine.Block("TallGrass",7,0.15),
new BCEngine.Block("Obsidian",8,4),
new BCEngine.Block("Portal",9,0.5),
new BCEngine.Block("Chicken",10,0.001),
new BCEngine.Block("Glass",11,0.25),
new BCEngine.Block("Rabbit",12,0.25),
new BCEngine.Block("Wood",13,0.5),
new BCEngine.Block("Leaves",14,0.25),
new BCEngine.Block("Plank",15,1.5),
new BCEngine.Block("TNT",16,2)
]
...
BCEngine.createEnvBoxes=function()
{
	...
	BCEngine.evnBoxSize = ( BCEngine.height -( BCEngine.cubeSize * 7 ) ) / 2 ;
...
BCEngine.initPlayArea = function()
{
	...
	BCEngine.playArea.style.height = ( BCEngine.cubeSize * 7 ) + "px";
...
window.onload=function()
{
	...
	BCEngine.map.chunk1 = "000000000000000000000000000 000000000000000000000000000 000000000000000000000000000 000000000000000000000070700 444444444444455554444444444 333333333333335533333333333 111111111111111111111111111";
